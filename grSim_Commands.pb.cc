...
void InitDefaultsgrSim_Robot_CommandImpl() {
...
void InitDefaultsgrSim_Robot_Command() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsgrSim_Robot_CommandImpl);
}

void InitDefaultsgrSim_CommandsImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_grSim_5fCommands_2eproto::InitDefaultsgrSim_Robot_Command();
  {
...
void InitDefaultsgrSim_Commands() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsgrSim_CommandsImpl);
}
...
grSim_Commands::grSim_Commands()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_grSim_5fCommands_2eproto::InitDefaultsgrSim_Commands();
  }
  SharedCtor();
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_robot_commands()));
        } else {
          goto handle_unusual;
        }
        break;
...
void grSim_Commands::SerializeWithCachedSizes(
  ...
  for (unsigned int i = 0,
    ...
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      3, this->robot_commands(static_cast<int>(i)), output);
  }
