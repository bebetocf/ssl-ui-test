...
inline void InitDefaults() {
  InitDefaultsSSL_RefereeRemoteControlRequest_CardInfo();
  InitDefaultsSSL_RefereeRemoteControlRequest();
  InitDefaultsSSL_RefereeRemoteControlReply();
}
}  // namespace protobuf_rcon_2eproto
...
class SSL_RefereeRemoteControlRequest_CardInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SSL_RefereeRemoteControlRequest.CardInfo) */ {
 public:
  ...
  inline SSL_RefereeRemoteControlRequest_CardInfo* New() const PROTOBUF_FINAL { return New(NULL); }

  SSL_RefereeRemoteControlRequest_CardInfo* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_rcon_2eproto::InitDefaultsSSL_RefereeRemoteControlRequest_CardInfoImpl();
};
// -------------------------------------------------------------------
...
class SSL_RefereeRemoteControlRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SSL_RefereeRemoteControlRequest) */ {
 public:
  ...
  inline SSL_RefereeRemoteControlRequest* New() const PROTOBUF_FINAL { return New(NULL); }

  SSL_RefereeRemoteControlRequest* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_rcon_2eproto::TableStruct;
  friend void ::protobuf_rcon_2eproto::InitDefaultsSSL_RefereeRemoteControlRequestImpl();
};
// -------------------------------------------------------------------
...
class SSL_RefereeRemoteControlReply : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SSL_RefereeRemoteControlReply) */ {
 public:
  ...
  inline SSL_RefereeRemoteControlReply* New() const PROTOBUF_FINAL { return New(NULL); }

  SSL_RefereeRemoteControlReply* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  int outcome_;
  friend struct ::protobuf_rcon_2eproto::TableStruct;
  friend void ::protobuf_rcon_2eproto::InitDefaultsSSL_RefereeRemoteControlReplyImpl();
};
// ===================================================================
