...
inline void InitDefaults() {
  InitDefaultsSSL_Referee_Game_Event_Originator();
  InitDefaultsSSL_Referee_Game_Event();
}
}  // namespace protobuf_game_5fevent_2eproto
...
class SSL_Referee_Game_Event_Originator : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SSL_Referee_Game_Event.Originator) */ {
 ...
 private:
  ...
  friend void ::protobuf_game_5fevent_2eproto::InitDefaultsSSL_Referee_Game_Event_OriginatorImpl();
};
// -------------------------------------------------------------------
...
class SSL_Referee_Game_Event : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SSL_Referee_Game_Event) */ {
 ...
 private:
  ...
  int gameeventtype_;
  friend struct ::protobuf_game_5fevent_2eproto::TableStruct;
  friend void ::protobuf_game_5fevent_2eproto::InitDefaultsSSL_Referee_Game_EventImpl();
};
// ===================================================================
