...
void InitDefaultsgrSim_RobotReplacementImpl() {
...
void InitDefaultsgrSim_RobotReplacement() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsgrSim_RobotReplacementImpl);
}

void InitDefaultsgrSim_BallReplacementImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
void InitDefaultsgrSim_BallReplacement() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsgrSim_BallReplacementImpl);
}

void InitDefaultsgrSim_ReplacementImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_grSim_5fReplacement_2eproto::InitDefaultsgrSim_BallReplacement();
  protobuf_grSim_5fReplacement_2eproto::InitDefaultsgrSim_RobotReplacement();
  {
...
void InitDefaultsgrSim_Replacement() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsgrSim_ReplacementImpl);
}
...
grSim_Replacement::grSim_Replacement()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_grSim_5fReplacement_2eproto::InitDefaultsgrSim_Replacement();
  }
  SharedCtor();
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_robots()));
        } else {
          goto handle_unusual;
        }
        break;
...
void grSim_Replacement::SerializeWithCachedSizes(
  ...
  for (unsigned int i = 0,
    ...
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      2, this->robots(static_cast<int>(i)), output);
  }
