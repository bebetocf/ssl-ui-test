...
void InitDefaultsgrSim_PacketImpl() {
...
void InitDefaultsgrSim_Packet() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsgrSim_PacketImpl);
}
...
grSim_Packet::grSim_Packet()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_grSim_5fPacket_2eproto::InitDefaultsgrSim_Packet();
  }
  SharedCtor();
