...
void InitDefaultsSSL_Referee_Game_Event_OriginatorImpl() {
...
void InitDefaultsSSL_Referee_Game_Event_Originator() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsSSL_Referee_Game_Event_OriginatorImpl);
}

void InitDefaultsSSL_Referee_Game_EventImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_game_5fevent_2eproto::InitDefaultsSSL_Referee_Game_Event_Originator();
  {
...
void InitDefaultsSSL_Referee_Game_Event() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsSSL_Referee_Game_EventImpl);
}
